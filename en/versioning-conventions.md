...
As a solution to this problem, was proposed a simple set of rules and
...
This set of rules was called "Semantic Versioning." Under this scheme, version numbers
...
Original source: [https://semver.org/](https://semver.org/)
